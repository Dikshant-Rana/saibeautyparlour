...
const SkincareServicesPage = () => {
    ...
    const skincareServices = [
        { name: "Cleansing", desc: "Refreshing deep facial cleanse.", price: "From NPR 1,000" },
                            ...
                            <div className="relative group h-full flex items-center" onMouseLeave={() => !('ontouchstart' in window) && setIsServicesOpen(false)}>
                                ...
                                <div className={`absolute top-full left-0 w-56 bg-white border border-gray-100 shadow-xl transition-all duration-200 z-50 ${isServicesOpen ? 'opacity-100 visible' : 'opacity-0 invisible'} group-hover:opacity-100 group-hover:visible`}>
                                    <div className="py-2">
                                        ...
                                        <Link to="/services/skincare" className="block px-5 py-2.5 text-sm text-pink-600 hover:bg-gray-50 transition-colors font-medium">Skincare Treatments</Link>
                            ...
                            <div className="px-3 py-1 space-y-1">
                                ...
                                {isServicesOpen && (
                                    <div className="ml-3 mt-1 space-y-1">
                                        ...
                                        <Link to="/services/skincare" className="block px-3 py-1.5 text-base font-medium text-pink-600 bg-pink-50">Skincare Treatments</Link>
            ...
            <main className="pt-28 pb-24 px-6 sm:px-6 max-w-5xl mx-auto">
                ...
                <div className="mb-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="text-center md:text-left">
                        ...
                        <h1 className="text-4xl md:text-6xl font-serif font-bold mb-6 text-gray-900">Skincare Treatments</h1>
