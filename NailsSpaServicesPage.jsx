...
const NailsSpaServicesPage = () => {
    ...
    const nailsSpaServices = [
        { name: "Acrylic / Gel Nail Extensions", desc: "Long-lasting extensions with custom art.", price: "Rs. 2,500" },
        { name: "Classic Manicure", desc: "Nail shaping, cuticle care, and polish application.", price: "Rs. 800" },
        { name: "Luxury Spa Pedicure", desc: "Exfoliating scrub, hydrating mask, and extended massage.", price: "Rs. 1,200" },
        { name: "Aromatherapy Full Body Massage", desc: "Deep tissue massage using warm essential oils.", price: "Rs. 3,000" },
        { name: "Full Body Waxing", desc: "Smooth and hair-free skin for weeks.", price: "Rs. 3,500" },
        { name: "Underarms Waxing", desc: "Gentle hair removal for underarms.", price: "Rs. 1000" },
        { name: "Face Waxing", desc: "Delicate hair removal for the face.", price: "Rs. 800" },
        { name: "Arms Waxing", desc: "Full or half arms waxing.", price: "Rs. 1,000" },
        { name: "Legs Waxing", desc: "Full or half legs waxing.", price: "Rs. 1,200" }
    ];
                            ...
                            <div className="relative group h-full flex items-center" onMouseLeave={() => !('ontouchstart' in window) && setIsServicesOpen(false)}>
                                ...
                                <div className={`absolute top-full left-0 w-56 bg-white border border-gray-100 shadow-xl transition-all duration-200 z-50 ${isServicesOpen ? 'opacity-100 visible' : 'opacity-0 invisible'} group-hover:opacity-100 group-hover:visible`}>
                                    <div className="py-2">
                                        ...
                                        <Link to="/services/nails-spa" className="block px-5 py-2.5 text-sm text-pink-600 hover:bg-gray-50 transition-colors font-medium">Nails & Spa Services</Link>
                            ...
                            <div className="px-3 py-1 space-y-1">
                                ...
                                {isServicesOpen && (
                                    <div className="ml-3 mt-1 space-y-1">
                                        ...
                                        <Link to="/services/nails-spa" className="block px-3 py-1.5 text-base font-medium text-pink-600 bg-pink-50">Nails & Spa Services</Link>
            ...
            <main className="pt-28 pb-24 px-6 sm:px-6 max-w-5xl mx-auto">
                ...
                <div className="mb-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="text-center md:text-left">
                        ...
                        <h1 className="text-4xl md:text-6xl font-serif font-bold mb-6 text-gray-900">Nails & Spa Services</h1>
