    ...
    const hairServices = [
        {
            ...
            subcategory: true,
            items: [
                { name: "Step Cut", desc: "Layered step cut for added volume and texture.", price: "From NPR 800" },
                { name: "V Cut", desc: "Classic V-shaped haircut.", price: "From NPR 600" },
                { name: "Thai Cut", desc: "Trendy Thai style haircut.", price: "From NPR 1,000" },
                { name: "U Cut", desc: "Simple and elegant U-shaped cut.", price: "From NPR 500" },
                { name: "Straight Cut", desc: "Clean and neat straight trim.", price: "From NPR 400" }
            ]
        },
        {
            name: "Hair Color",
            ...
            items: [
                ...
                { name: "Highlights / Lowlights", desc: "Foil highlights for added dimension.", price: "From NPR 3,500" },
        ...
        },
        {
            ...
            subcategory: true,
            items: [
                { name: "Permanent Straightening", desc: "Long-lasting sleek, straight hair.", price: "From NPR 5,000" },
                { name: "Keratin Treatment", desc: "Frizz control, repair and smoothening.", price: "From NPR 6,000" },
                { name: "Hair Relaxing", desc: "Loosen tight curls for manageable hair.", price: "From NPR 4,000" },
                { name: "Rebonding", desc: "Silky, pin-straight rebonding treatment.", price: "From NPR 5,500" }
            ]
        },
        {
            name: "Hair Perm",
            subcategory: true,
            items: [
                { name: "Classic Cold Perm", desc: "Traditional tight curly perm.", price: "From NPR 4,000" },
                { name: "Digital / Hot Perm", desc: "Modern, soft wave perm.", price: "From NPR 5,500" }
            ]
        }
    ];
                        ...
                        <nav className="hidden md:flex space-x-8 items-center">
                            ...
                            <div className="relative group h-full flex items-center" onMouseLeave={() => !('ontouchstart' in window) && setIsServicesOpen(false)}>
                                ...
                                <div className={`absolute top-full left-0 w-56 bg-white border border-gray-100 shadow-xl transition-all duration-200 z-50 ${isServicesOpen ? 'opacity-100 visible' : 'opacity-0 invisible'} group-hover:opacity-100 group-hover:visible`}>
                                    <div className="py-2">
                                        <Link to="/services/hair" className="block px-5 py-2.5 text-sm text-pink-600 hover:bg-gray-50 transition-colors font-medium">Hair Styling & Care</Link>
                            ...
                            <div className="px-3 py-1 space-y-1">
                                ...
                                {isServicesOpen && (
                                    <div className="ml-3 mt-1 space-y-1">
                                        <Link to="/services/hair" className="block px-3 py-1.5 text-base font-medium text-pink-600 bg-pink-50">Hair Styling & Care</Link>
            ...
            <main className="pt-28 pb-24 px-6 sm:px-6 max-w-5xl mx-auto">
                ...
                <div className="mb-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="text-center md:text-left">
                        ...
                        <h1 className="text-4xl md:text-6xl font-serif font-bold mb-6 text-gray-900">Hair Styling & Care</h1>
