    ...
    const weddingPackages = [
        {
            ...
            subcategory: true,
            items: [
                { name: "Bridal Makeup", desc: "Includes Gold Facial, Gel Nail Extension, Manicure & Pedicure", price: "Rs. 25,500" },
                { name: "Reception Makeup", desc: "Includes Gold Facial, Manicure & Pedicure", price: "Rs. 12,500" },
                { name: "Engagement Makeup", desc: "Includes Gold Facial & Gel Nail", price: "Rs. 15,500" }
            ]
        },
        {
            ...
            subcategory: true,
            items: [
                { name: "Party Attend Makeup", desc: "As per the hair styling requirement", price: "Rs. 7,000" },
                { name: "Evening Makeup", desc: "Elegant evening look + Hair Styling", price: "Rs. 5,500" },
                { name: "Baby Shower Makeup", desc: "Glowing maternity makeup + Hair Styling", price: "Rs. 6,500" },
                { name: "Bratamanda Makeup", desc: "Traditional ceremony makeup + Hair Styling", price: "Rs. 7,500" },
                { name: "Rice Feeding Makeup", desc: "Special occasion makeup + Hair Styling", price: "Rs. 5,000" },
                { name: "Anniversary Makeup", desc: "Romantic celebration makeup + Hair Styling", price: "Rs. 10,500" }
            ]
        },
        {
            name: "Makeup Only",
            ...
            subcategory: true,
            items: [
                { name: "Bridal Makeup", desc: "Includes Gold Facial + Hair Styling", price: "Rs. 12,500" },
                { name: "Engagement Makeup", desc: "Complete engagement look + Hair Styling", price: "Rs. 5,500" },
                { name: "Reception Makeup", desc: "With Airbrush Makeup + Hair Styling", price: "Rs. 10,500" }
            ]
        },
        {
        ...
        },
        {
            ...
            subcategory: true,
            items: [
                { name: "Bride Mehendi", desc: "Traditional intricate bridal henna design", price: "Rs. 3,500 – 8,000" },
                { name: "Bridesmaid Mehendi", desc: "Beautiful henna designs for bridesmaids", price: "Rs. 2,000 – 7,500" },
                { name: "Festive Mehendi", desc: "Festival and celebration henna designs", price: "Rs. 1,500 – 5,500" }
            ]
        }
    ];
                            ...
                            <div className="relative group h-full flex items-center" onMouseLeave={() => !('ontouchstart' in window) && setIsServicesOpen(false)}>
                                ...
                                <div className={`absolute top-full left-0 w-56 bg-white border border-gray-100 shadow-xl transition-all duration-200 z-50 ${isServicesOpen ? 'opacity-100 visible' : 'opacity-0 invisible'} group-hover:opacity-100 group-hover:visible`}>
                                    <div className="py-2">
                                        ...
                                        <Link to="/services/wedding" className="block px-5 py-2.5 text-sm text-pink-600 hover:bg-gray-50 transition-colors font-medium">Wedding Packages</Link>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="px-3 py-1 space-y-1">
                                ...
                                {isServicesOpen && (
                                    <div className="ml-3 mt-1 space-y-1">
                                        ...
                                        <Link to="/services/wedding" className="block px-3 py-1.5 text-base font-medium text-pink-600 bg-pink-50">Wedding Packages</Link>
                                    </div>
                                )}
                            </div>
                            <div className="px-3 py-1 space-y-1">
            ...
            <main className="pt-28 pb-24 px-6 sm:px-6 max-w-5xl mx-auto">
                ...
                <div className="mb-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="text-center md:text-left">
                        ...
                        <h1 className="text-4xl md:text-6xl font-serif font-bold mb-6 text-gray-900">Wedding Packages</h1>
                ...
                <div className="mt-24 pt-16 border-t border-gray-200 text-center">
                    ...
                    <Link to="/contact" className="inline-block px-8 py-3 bg-pink-500 hover:bg-pink-600 text-white text-xs font-bold uppercase tracking-wide rounded-sm transition-colors">
